...
import { listDocs, createDoc, updateDoc, deleteDoc, DEFAULT_DOC_CATEGORIES, type CompanyDoc } from '@/lib/company-docs'
...
export default function CompanyDocsTab() {
  ...
  const [categories, setCategories] = useState<string[]>([...DEFAULT_DOC_CATEGORIES])
  ...
  return (
    <div className="flex h-full min-h-[600px] gap-4">
      <div className="w-44 shrink-0 border-r border-neutral-800 pr-3">
        <div className="mb-3 text-xs font-semibold uppercase tracking-wide text-neutral-500">Categories</div>
        <button
      ...
      <div className="w-72 shrink-0 border-r border-neutral-800 pr-3">
        <div className="mb-3 flex items-center justify-between">
          <span className="text-xs font-semibold uppercase tracking-wide text-neutral-500">Docs</span>
          <button
            onClick={startNewDoc}
        ...
        {!loading && docs.length === 0 && (
          <div className="text-sm text-neutral-500">Nothing here yet. Start a doc to plan the next move.</div>
        )}
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {addingCategory && (
                <div className="flex items-center gap-1">
                  ...
                  />
                  <button onClick={confirmNewCategory} className="rounded bg-white px-2 py-1 text-xs font-medium text-black">
                    Add
                  </button>
                </div>
              )}
